...
} from 'src/app/rooster/rooster-store/rooster.index';
...
import { Player } from 'src/app/rooster/interfaces/player.interface';
import { Rooster } from 'src/app/rooster/interfaces/rooster.interface';
import { ArmyStoreActions } from 'src/app/army/army-store/army.index';
